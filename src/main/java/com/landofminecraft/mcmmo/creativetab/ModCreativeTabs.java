package com.landofminecraft.mcmmo.creativetab;
...
public class ModCreativeTabs {
	...
	public static final CustomCreativeTab CREATIVE_TAB = new CustomCreativeTab(ModReference.MOD_ID, new ItemStack(Items.SHIELD), true);
