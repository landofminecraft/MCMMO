...
public class BlockStainedHardenedClayStructureHorizontal extends BlockModStructureHorizontal {

	public static final String SUFFIX = "terracotta_" + BlockModStructureHorizontal.SUFFIX;

	private final EnumDyeColor color;

	public BlockStainedHardenedClayStructureHorizontal(final EnumDyeColor color) {
